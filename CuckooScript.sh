#!/bin/bash
#
# Install & Deploy a Cuckoo sandbox
# Author: Jay Gajjar
...
echo -e "\033[41;30m   Cuckoo Script By Jay Gajjar  \033[0m"
echo -e "\033[41;30m--------------------------------\033[0m"
...
echo -e "\033[42;30m Done! Cuckoo web service running on port 8000 so can be accessd by -- localhost:8000 -- \033[0m"
echo -e "\033[42;30m-----------------------------------------------\033[0m"
